...
<div class="page-container">
	<div class="text-c">
		<form class="Huiform" method="post" action="" target="_self">
			<input type="text" placeholder="分类名称" id="add" value="" class="input-text" style="width:120px">
	...
	<%--<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> &lt;%&ndash;批量删除&ndash;%&gt;</a></span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>--%>
	<div class="mt-20">
			...
			<tbody>
				<c:forEach items="${requestScope.list}" var="list">
					<tr class="text-c">
						...
						<%--<td class="f-14 product-brand-manage"><a style="text-decoration:none" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> </td>--%>
					</tr>
				</c:forEach>
...
function picture_colume_add(a) {
    var name = $("#add").val()
    location = "${ctx}/product/product-category-addc2?c1=${requestScope.c1}&name="+name
}
</script>
</body>
</html>