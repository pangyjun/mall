...
<link href="lib/Hui-iconfont/1.0.8/iconfont.css" rel="stylesheet" type="text/css" />
  ...
  <%--<script type="text/javascript" href="${ctx}/static/js/jquery-1.8.3.min.js"></script>--%>
    ...
    <%--<form class="form form-horizontal" action="index.jsp" method="post">--%>
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <input id="btn" type="submit" class="btn btn-success radius size-L" value="&nbsp;登&nbsp;&nbsp;&nbsp;&nbsp;录&nbsp;">
